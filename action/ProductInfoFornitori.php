...
class ProductInfoFornitori extends DBSmartyAction
{
	var $className;
	
	function ProductInfoFornitori()
	{
		...
		{
			$BeanGiacenze = new giacenze_fornitori($this->conn, $_REQUEST['id']);
...
// 		$this->tEngine->assign('releated', $List);
		...
		$this->tEngine->assign('tpl_action', 'SearchFornitori/ProductInfo');
