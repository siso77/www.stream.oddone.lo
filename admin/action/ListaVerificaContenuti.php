...
class ListaVerificaContenuti extends DBSmartyAction
{
	var $className;
	...
	function ListaVerificaContenuti()
	{
...
// 			$where .= ' ORDER BY content.data_inserimento_riga DESC';
		...
		$BeanContent = new content();
		$List = $BeanContent->dbGetVerificaCodici($this->conn, $where, new giacenze(), $_SESSION[$this->className]['key_searched']['id_fornitore']);
