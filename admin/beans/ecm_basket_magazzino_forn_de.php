...
class ecm_basket_magazzino_forn_de extends BeanBase
{
	var $id;
	var $id_basket;
	var $id_magazzino;
	...
	function ecm_basket_magazzino_forn_de($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "ecm_basket_magazzino_forn_de";
