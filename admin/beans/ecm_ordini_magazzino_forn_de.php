...
class ecm_ordini_magazzino_forn_de extends BeanBase
{
	var $id;
	var $id_ordine;
	var $id_magazzino;
	...
	function ecm_ordini_magazzino_forn_de($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "ecm_ordini_magazzino_forn_de";
