...
class newsletter_emails extends BeanBase
{
	var $id;
	var $email;

	function newsletter_emails($conn=null, $id=null)
	{
		parent::BeanBase();

		$this->table_name = "newsletter_emails";
	...
	function dbDelete($db=null, $email)
	{
	...
	function dbSearch($db=null, $search=null)
	{
		...
		$query="SELECT * FROM ".$this->table_name." WHERE email = '".$search."'";
