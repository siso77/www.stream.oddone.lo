...
class banner extends BeanBase
{
	...
	function banner($conn=null, $id=null)
	{
		parent::BeanBase();
	...
	function getImage_name(){return $this->image_name;}

	function setImage_name($value= null)
	{
				if(strlen($value) > 255)
			$value = substr($value, 0, 255);
				
								
		$this->image_name = (string)$value;
	}
