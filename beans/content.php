...
function dbSearchDisponibili($db=null, $search=null)
	{
		...
		$query="SELECT
					...
					gruppi_merceologici.name as gruppo_it,
					gruppi_merceologici.name_en as gruppo_en,
					gruppi_merceologici.name_fr as gruppo_fr,
					gruppi_merceologici.name_de as gruppo_de,
					
					gruppi_merceologici.description as gruppo_des_it,
					gruppi_merceologici.description_en as gruppo_des_en,
					gruppi_merceologici.description_fr as gruppo_des_fr,
					gruppi_merceologici.description_de as gruppo_des_de,
...
// 				WHERE content.is_active = 1".$search;
	...
	function setDescrizione_it($value= null)
	{
		...
		$this->descrizione_it = (string)  mysql_real_escape_string($value);
	}
	...
	function setNome_en($value= null)
	{
		...
		$this->nome_en = (string)  mysql_real_escape_string($value);
	}
	...
	function setDescrizione_en($value= null)
	{
		...
		$this->descrizione_en = (string)  mysql_real_escape_string($value);
	}
	
	
function getNome_fr(){return $this->nome_fr;}

	function setNome_fr($value= null)
	{
		$this->nome_fr = mysql_real_escape_string($value);
	}

		function getDescrizione_fr(){return $this->descrizione_fr;}

	function setDescrizione_fr($value= null)
	{
		$this->descrizione_fr = $value;
	}
	
function getNome_de(){return $this->nome_de;}

	function setNome_de($value= null)
	{
		$this->nome_de = mysql_real_escape_string($value);
	}

		function getDescrizione_de(){return $this->descrizione_de;}

	function setDescrizione_de($value= null)
	{
		$this->descrizione_de = $value;
	}
	...
	function getNote(){return mysql_real_escape_string($this->note);}
	
	function setNote($value= null)
	{
		$this->note = mysql_real_escape_string($value);
	}
