...
class content_extra extends BeanBase
{
	var $id;
	var $id_content;
	var $extra_name;
	...
	function content_extra($conn=null, $id=null)
	{
		parent::BeanBase();

		$this->table_name = "content_extra";
	...
	function dbGetAllByExtraName($db=null, $idContent, $extraName)
	{
		if (!$this->_is_connection($db))
			return false;

		$values=array();
		$query="SELECT * FROM ".$this->table_name." WHERE id_content = ".$idContent." AND extra_name = '".$extraName."'";
...
$this->setID($id);
	...
	function setId_content($value= null)
	{
		...
		function getExtra_name(){return $this->extra_name;}

	function setExtra_name($value= null)
	{
				
								
		$this->extra_name = (string)$value;
	}

		function getExtra_value(){return $this->extra_value;}

	function setExtra_value($value= null)
	{
				
								
		$this->extra_value = (string)$value;
	}
