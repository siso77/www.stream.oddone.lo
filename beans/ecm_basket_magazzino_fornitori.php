...
class ecm_basket_magazzino_fornitori extends BeanBase
{
	var $id;
	var $id_basket;
	var $id_magazzino;
	...
	function ecm_basket_magazzino_fornitori($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "ecm_basket_magazzino_fornitori";
	...
	function setQuantita_pianale($value= null)
	{
		...
		$this->quantita_pianale = (int)$value;
	}
