...
class ecm_ordini_magazzino_fornitori extends BeanBase
{
	var $id;
	var $id_ordine;
	var $id_magazzino;
	...
	var $quantita;
	var $name_it;
	var $quantita_pianale;
	var $nota;
	var $indispensabile;
	var $importo;

	function ecm_ordini_magazzino_fornitori($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "ecm_ordini_magazzino_fornitori";
	...
	function getQuantita_pianale(){return $this->quantita_pianale;}

	function setQuantita_pianale($value= null)
	{
		if(strlen($value) > 4)
			$value = substr($value, 0, 4);
				
								
		$this->quantita_pianale = (string)$value;
	}
