...
class riferimento_new_age extends BeanBase
{
	var $id;
	var $bolla_new_age;
	var $data_new_age;
	...
	function riferimento_new_age($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "riferimento_new_age";
	...
	function getBolla_new_age(){return $this->bolla_new_age;}

	function setBolla_new_age($value= null)
	{
				if(strlen($value) > 255)
			$value = substr($value, 0, 255);
				
								
		$this->bolla_new_age = (string)$value;
	}

	function getData_new_age(){return $this->data_new_age;}

	function setData_new_age($value= null)
	{
				
				if(strrpos($value, "-") != 7)
		{
			echo "Errore nel settaggio della properies data_new_age!";
			exit;
		}
								
		$this->data_new_age = (string)$value;
	}

	function getData_bolla(){return $this->data_bolla;}

	function setData_bolla($value= null)
	{
				
				if(strrpos($value, "-") != 7)
		{
			echo "Errore nel settaggio della properies data_bolla!";
			exit;
		}
								
		$this->data_bolla = (string)$value;
	}
