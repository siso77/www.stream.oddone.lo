...
class sconti extends BeanBase
{
	...
	function sconti($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "sconti";
	...
	function getPercentuale(){return $this->percentuale;}

	function setPercentuale($value= null)
	{
