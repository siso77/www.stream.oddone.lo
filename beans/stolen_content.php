...
class stolen_content extends BeanBase
{
	...
	function dbGetAllCustom($db=null, $BeanImagesMercatino = null)
	{
		...
		$values=array();
		$query="SELECT *, data_inserimento_riga + INTERVAL 1 MONTH as expiration FROM ".$this->table_name." WHERE is_active = 1 AND NOW() <= data_inserimento_riga + INTERVAL 1 MONTH";
